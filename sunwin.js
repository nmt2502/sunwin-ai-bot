...
const TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..SOELZ6lJag52donVwUPuTuEWQbq8wiq8BrdEccJCmSY";
...
const start = async () => {
    try {
        ...
        console.log(`\n==============================================`);
        console.log(`🚀 MinhTuanzZz Sunwin AI ULTRA Server`);
        console.log(`==============================================`);
...
function connectRikWebSocket() {
    ...
    rikWS.on("open", () => {
        ...
        const authPayload = [1, "MiniGame", "SC_nmt2502", "Tkwong5579", {
            info: JSON.stringify({
                ipAddress: "42.117.146.196",
                wsToken: TOKEN,
                userId: "ab8f94c4-2616-4275-9c23-5a21d05afa89",
                username: "SC_nmt2502",
                timestamp: Date.now(),
            }),
            signature: "",
            pid: 4,
            subi: true,
        }];
